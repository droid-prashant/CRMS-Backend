package np.com.prashant.crimerecordmanagement.models;
...
public class User {
	...
	@JsonIgnore
		private List<PoliceStaffPicture>psp=new ArrayList<>();
	
	@JsonIgnore
	@OneToMany(mappedBy = "img_user")
	private List<EvidenceRecord>evidence=new ArrayList<>();
	
	@JsonIgnore
	@OneToOne(mappedBy = "obj")
	private PoliceStaffRegistration psr;
